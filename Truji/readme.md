...
- Git Bash, PowerShell  en Windows
...
- Inventario de estaciones (maestro de estaciones): `/api/valores/climatologicos/inventarioestaciones/todasestaciones`
- Inventario de estaciones (valores climatológicos): `/api/valores/climatologicos/diarios/datos/fechaini/{fechaIniStr}/fechafin/{fechaFinStr}/estacion/{idema}`

El resultado de la conexion te da otra URL con los metadatos para sacar la informacion.
